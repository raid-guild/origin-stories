                ...
                <div className="grid grid-cols-3 xl:px-28 lg:px-24 md:px-20 gap-16 pt-8 h-full -mt-48">
                    <main className="col-span-2 z-[999]">
                        ...
                        <article className="prose prose-lg mt-8 font-sans">
                            ...
                            <h4>Travis</h4>
                            <p>
                                You&apos;re a member of numerous DAOs at this
                                point and continue to spearhead some of them.
                            ...
                            <p>
                                ...
                                tokens in other token-multisig-snapshot DAOs and
                                I vote in them sometimes, but I wouldn&apos;t
                                necessarily listall of those. The main DAOs that
                                I&apos;m active in are MetaCartel, RaidGuild,
                                DAOhaus, and UberHaus
                            </p>
                            ...
                            <div className="speaker flex gap-x-16">
                                ...
                                <p>
                                    ...
                                    wouldn&apos;t necessarily listall of those.
                        ...
                        <p className="speaker flex gap-x-16 mt-6">
                            ...
                            <p className="w-3/4">
                                ...
                                where all those DAOs meet. Maybe I could put it
                                like this: What do you see as the relationship
                                between those DAOs? How would you describe it?
                            </p>
                        </p>
                        <p className="speaker flex gap-x-16 mt-6">
                            <p className="font-bold">Travis</p>
                        ...
                        <p className="speaker flex gap-x-16 mt-6">
                            ...
                            <p className="w-3/4">
                                ...
                                tokens in other token-multisig-snapshot DAOs and
                                I vote in them sometimes, but I wouldn&apos;t
                                necessarily list all of those. The main DAOs
                                that I&apos;m active in are MetaCartel,
                                RaidGuild, DAOhaus, and UberHaus
                            </p>
                        </p>
