                ...
                <div className="h-[650px] relative">
                    <div className=" relative z-10">
                        ...
                        <div className="flex flex-col px-6">
                            <h1 className="font-display text-5xl mt-10">
                            ...
                            <p className="pt-6 leading-7">
                                ...
                                were they doing before joining the Guild? What
                                has their experience been like so far in Web3?
                                What is life really like working in DAO? The
