        ...
        <Fragment>
            <div className="max-w-sm bg-dark backdrop-blur p-6 rounded tracking-normal">
                <p>
                    ...
                    other token-multisig-snapshot DAOs and I vote in them
                    sometimes, but I wouldn't necessarily list all of those. The
                    main DAOs that I'm active in are MetaCartel, RaidGuild,
        ...
        <Fragment>
            <div className="max-w-md bg-dark ring ring-yellow-400 ring-inset backdrop-blur p-6 rounded tracking-normal">
                ...
                <p>
                    &quot;I would count the permissioned DAOs. I own tokens in
                    other token-multisig-snapshot DAOs and I vote in them
                    sometimes, but I wouldn&apos;t necessarily list all of
                    those. The main DAOs that I&paos;m active in are MetaCartel,
